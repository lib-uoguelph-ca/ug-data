...
{{ Form::select('scca_class[]', array(
	...
	), $input['scca_class'], array('multiple' => 'true', 'id' => 'scca_class')); }}
...
{{ Form::select('scca_subclass[]', array(
		...
		'scca_subclass_e' => 'Subclass E - Erosion', 
		'scca_subclass_f' => 'Subclass F - Low natural fertility', 
	...
	), $input['scca_subclass'], array('multiple' => 'true', 'id' => 'scca_subclass')); }}
